...
public class Box : IBounds
{
    ...
    /// <summary>Returns <c>true</c> if this bounding box straddles the Antimeridian.</summary>
    ...
    /// <summary>Returns <c>true</c> if this bounding box is empty (<c>maxY</c> is less than <c>minY</c>).</summary>
    ...
    /// <summary>Checks if this bounding box includes the given coordinate, and expands it if necessary.</summary>
    ...
    /// <summary>Creates a JTS Envelope with the same dimensions as this bounding box.</summary>
    ...
    /// <summary>Moves the bounding box horizontally and vertically by the specified number of units.</summary>
    ...
    /// <summary>Creates a <c>Box</c> with the given bounds (west, south, east, north).</summary>
    ...
    /// <summary>Creates a <c>Box</c> that covers a single point.</summary>
