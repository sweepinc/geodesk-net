...
public class SpatialFilterTest
{
    ...
    public void TestSpatial()
    {
        ...
        var found = new HashSet<IFeature>();
    ...
    class State
    {
        internal IFeature feature = null!;
    ...
    public void TestSpatialStates()
    {
        ...
        for (var i = 0; i < 1; i++)
        {
            ...
            var countyCount = 0;
            var countySet = new HashSet<IFeature>();
    ...
    public void TestSpatialCityBuildings()
    {
        ...
        for (var run = 0; run < 10; run++)
        {
            ...
            IFeature? cityWithMostBuildings = null;
    ...
    public void TestSpatialCityChurches()
    {
        ...
        for (var run = 0; run < 10; run++)
        {
            ...
            IFeature? cityWithMostChurches = null;
            long mostChurches = 0;
            foreach (var city in world.Select("a[boundary=administrative][admin_level=8][name]"))
            {
                cityCount++;
