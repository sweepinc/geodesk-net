...
// Validates the Segment byte-window abstraction introduced for the .NET port (no direct
// Java counterpart test). Store data is always little-endian.
public class SegmentTest
{
    ...
    {
        Segment buf = Segment.Allocate(64);
    ...
    {
        Segment buf = Segment.Allocate(16);
        buf.PutInt(0, 1);
        buf.PutInt(4, 2);
        Segment slice = buf.Slice(4, 12);
